...
import './MessageContentLimitsImpl.sol';

contract MessageContentLimitsInit {
  function setMaxContentLength(uint256 len) external {
    MessageContentLimitsImpl.setMaxLength(len);
  }
}
