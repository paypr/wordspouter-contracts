...
contract BasicMessageCostERC721Hooks is ERC721HooksBase {
  function beforeMint(
    address, /*account*/
    uint256 /*tokenId*/
  ) external payable virtual override {
    if (msg.value < MessageCostImpl.basicCost()) {
      revert IMessageCost.ValueDoesNotMeetCost(MessageCostImpl.basicCost());
    }
  }
}
